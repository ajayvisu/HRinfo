...
<div className="container mt-5 mb-5">
    <div className="row">
        <div className="col-md-12">
            ...
            <div className="row">
                <div className="col-md-4"> <span className="fw-bold">Net Pay : 24528.00</span> </div>
            ...
            <div className="d-flex justify-content-end">
                <div className="d-flex flex-column mt-2"> <span className="fw-bolder">For Kalyan Jewellers</span> <span className="mt-4">Authorised Signatory</span> </div>
            </div>
        </div>
    </div>
</div>
