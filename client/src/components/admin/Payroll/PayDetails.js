...
setTransaction({
  ...
  {/* <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"></link> */}
            ...
            {/* <h2>Menu</h2> */}
  <input type="text" className="search-box" onChange={(key) => searchproduct(key.target.value)} placeholder="Search" />

          
    {/* <input type="text" placeholder="Search.." style={{marginLeft:"0%", marginTop:'20px'}} name="search"  onChange={searchEmployee}/> */}
